...
pip install sentencepiece datasets evaluate accelerate scikit-learn liger_kernel schedulefree wheel wandb
# pip install bitsandbytes deepspeed tf-keras "numpy<2" 
