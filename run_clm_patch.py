...
class DataTrainingArguments:
    ...
    preprocessed_dataset_name: str = field(
        default=None, metadata={"help": "The preprocessed dataset name."}
    )
...
def main():
    ...
    if model_args.model_name_or_path:
        ...
        logger.info(f"Training new model from scratch - Total size={n_params/2**30:.2f}B params")
    else:
        model = LlamaForCausalLM.from_pretrained(
